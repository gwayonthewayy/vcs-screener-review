...
2. Missing practical flags, stale/fallback leadership, unverified earnings, missing/below-EMA21 RS, ambiguous business classification, excessive extension, and high-risk biotech all fail closed.
3. Sector score 60 is a real boundary and VCS is not rewarded twice.
4. Weekly-universe refresh never overwrites a valid cache with an empty or failed refresh.
